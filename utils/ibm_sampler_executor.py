"""IBM Quantum hardware executor — real-device counterpart to NoisySamplerExecutor."""
...
__all__ = ["IbmSamplerExecutor"]


class IbmSamplerExecutor:
    """Executes quantum circuits on real IBM Quantum hardware.

    Drop-in replacement for ``NoisySamplerExecutor`` with identical public
